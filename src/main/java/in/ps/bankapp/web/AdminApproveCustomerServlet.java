...
public class AdminApproveCustomerServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        boolean status = dao.approveCustomer(cid);

        if (status) {
            resp.sendRedirect(req.getContextPath() + "/admin/pending-customers?success=approved");
        } else {
