...
public class AdminRejectAccountServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        boolean status = dao.rejectAccount(accId);

        if (status) {
            resp.sendRedirect(req.getContextPath() + "/admin/pending-accounts?success=rejected");
        } else {
