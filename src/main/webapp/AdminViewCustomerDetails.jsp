...
<%!
    // JSP DECLARATION BLOCK START: Methods must be placed here.
    ...
    // JSP DECLARATION BLOCK END
%>

<%
    // START OF STANDARD SCRIPTLET: This block runs the code.
...
<head>
    <meta charset="UTF-8">
    <title>NexusAdmin – Customer Details</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        a { text-decoration: none; color: inherit; } /* Ensure basic links have no underline */
        ...
        .nav-item.active a {
            ...
            text-decoration: none !important; /* FIX: Prevent underline */
        }
        .nav-item:hover a i,
        ...
        /* 1. Pending Active Link (Yellow/Dark Text) */
        ...
        /* 2. Danger Active Link (Red/White Text) */
        ...
        /* Customer Details Grid (New Structure) */
        .details-grid {
            display: grid;
...
<div class="layout">
    ...
    <main class="main">
        ...
        <header class="main-header">
            <div>
                <h1><i class="fas fa-user" style="color: var(--primary-color);"></i> Customer Details</h1>
                <p class="sub-title">Summary of customer profile, accounts, and transactions for <%= cust.getFirst_name() %>.</p>
            </div>
        ...
        <div class="card">
            <h2>Personal Information (CID: <%= cust.getCid() %>)</h2>
            ...
            <div class="details-grid">
                ...
                <div class="detail-item">
                    ...
                    <span class="detail-value"><%=cust.getDate()%></span>
                </div>
        ...
        <div class="card">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td><span class="status-pill <%= getStatusClass(a.getStatus()) %>"><%=a.getStatus().toUpperCase()%></span></td>
                </tr>
                <% } } else { %>
                <tr>
                    <td colspan="4" style="text-align:center; color:var(--text-light); padding:20px;">
                        <i class="fas fa-wallet"></i> Customer currently has no accounts.
                    </td>
                </tr>
                <% } %>
                </tbody>
        ...
        <div class="card">
            ...
            <table>
                ...
                <% } } else { %>
                <tr>
                    <td colspan="8" style="text-align:center; color:var(--text-light); padding:20px;">
                        <i class="fas fa-exchange-alt"></i> No transaction history found.
                    </td>
                </tr>
                <% } %>
                </tbody>
