...
<%
    ...
    ArrayList<Customer> list = (ArrayList<Customer>) request.getAttribute("pendingList");
...
<title>Admin – Pending Customer Approval</title>
    ...
    <main class="main-content">
        ...
        <header class="main-header">
            <div class="header-title">
                <h1><i class="fas fa-user-check" style="color: var(--warning-color);"></i> Pending Approvals</h1>
                <p>Review and process new customer registration requests.</p>
            </div>
            ...
            <table>
                    ...
                    <td>
                        <div class="actions">
                            <a class="action-btn approve"
                               href="<%=request.getContextPath()%>/admin/customer/approve?cid=<%=c.getCid()%>"
                               title="Approve Customer">
                                <i class="fas fa-check"></i> Approve
                            </a>

                            <a class="action-btn reject"
                               href="<%=request.getContextPath()%>/admin/customer/reject?cid=<%=c.getCid()%>"
                ...
                <tr>
                    <td colspan="6" style="text-align:center; padding:20px; color: var(--text-light);">
                        <i class="fas fa-info-circle"></i> No pending customer registration requests.
                    </td>
                </tr>
